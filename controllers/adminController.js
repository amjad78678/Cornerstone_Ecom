...
const
  loadAdminHome = async (req, res) => {
    try {
      ...
      res.render('adminHome', { admin: userData, userYearCount, allProfitYears, paymentMethods, paymentCounts, salesYearTotal, salesTotalYear, monthlyEarning, cancelledOrders, deliveredOrders, placedOrders, pendingOrders, latestOrders, latestUsers, countProduct, countCategory, salesdataCount, userdataCount, revenue })
